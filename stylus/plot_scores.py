...
def parse_candidates(folder: str) -> list[dict]:
    """
    Reads all cand_*.wav files from the folder and extracts alpha/gamma
    from the filename.
    """
    entries = []
...
def main():
    # ── Paramètres ────────────────────────────────────────────────────────────
    folder = "./test_outputs/chime1_violin1/grid_search"  # folder generated by generate_candidates()

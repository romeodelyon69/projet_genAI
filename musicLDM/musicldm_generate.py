"""
MusicLDM — Music generation from a text prompt
--------------------------------------------------------
Usage:
...
if __name__ == "__main__":
    prompt = "melodic, piano"  # default prompt
    output_path = "./generated/output.wav"  # default output path
    duration = 15.0  # default duration
    guidance_scale = 7.0  # default guidance scale
    n_steps = 50  # default number of steps
    n_candidates = 1  # default number of candidates
    main(prompt, output_path, duration, guidance_scale, n_steps, n_candidates)
